        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-12  " method="post" action="./deleteBookValidate.php">
                ...
                <div class="mt-3">
                  <input type="submit" name="deletebook" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="Delete Book">
                </div>
               </div>

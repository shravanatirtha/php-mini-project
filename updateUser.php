        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-12  " method="post" action="./updateUserValidate.php">
                ...
                <div class="mt-3">
                  <input type="submit" name="updateuser" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" value="Update User">
                </div>
               </div>
